...
#define __PYX_HAVE__dfs__constants
#define __PYX_HAVE_API__dfs__constants
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from 'dfs.constants' */
#define __Pyx_MODULE_NAME "dfs.constants"
extern int __pyx_module_is_main_dfs__constants;
int __pyx_module_is_main_dfs__constants = 0;

/* Implementation of 'dfs.constants' */
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_dfs__constants) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "dfs.constants")) {
      if (unlikely(PyDict_SetItemString(modules, "dfs.constants", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  __Pyx_INCREF(__pyx_n_s_salary);
  __Pyx_GIVEREF(__pyx_n_s_salary);
  PyList_SET_ITEM(__pyx_t_1, 1, __pyx_n_s_salary);
  __Pyx_INCREF(__pyx_n_s_position);
  __Pyx_GIVEREF(__pyx_n_s_position);
  PyList_SET_ITEM(__pyx_t_1, 2, __pyx_n_s_position);
  __Pyx_INCREF(__pyx_n_s_team);
  __Pyx_GIVEREF(__pyx_n_s_team);
  PyList_SET_ITEM(__pyx_t_1, 3, __pyx_n_s_team);
  __Pyx_INCREF(__pyx_n_s_opposing_team);
  __Pyx_GIVEREF(__pyx_n_s_opposing_team);
  PyList_SET_ITEM(__pyx_t_1, 4, __pyx_n_s_opposing_team);
  __Pyx_INCREF(__pyx_n_s_median_value);
  __Pyx_GIVEREF(__pyx_n_s_median_value);
  PyList_SET_ITEM(__pyx_t_1, 5, __pyx_n_s_median_value);
  __Pyx_INCREF(__pyx_n_s_upper_value);
  __Pyx_GIVEREF(__pyx_n_s_upper_value);
  PyList_SET_ITEM(__pyx_t_1, 6, __pyx_n_s_upper_value);
  __Pyx_INCREF(__pyx_n_s_lower_value);
  __Pyx_GIVEREF(__pyx_n_s_lower_value);
  PyList_SET_ITEM(__pyx_t_1, 7, __pyx_n_s_lower_value);
  __Pyx_INCREF(__pyx_n_s_median);
  __Pyx_GIVEREF(__pyx_n_s_median);
  PyList_SET_ITEM(__pyx_t_1, 8, __pyx_n_s_median);
  __Pyx_INCREF(__pyx_n_s_upper);
  __Pyx_GIVEREF(__pyx_n_s_upper);
  PyList_SET_ITEM(__pyx_t_1, 9, __pyx_n_s_upper);
 ...
 */
  ...
  __Pyx_GIVEREF(__pyx_n_s_lineup_num);
  PyList_SET_ITEM(__pyx_t_1, 0, __pyx_n_s_lineup_num);
  __Pyx_INCREF(__pyx_n_s_points_avg);
  __Pyx_GIVEREF(__pyx_n_s_points_avg);
  PyList_SET_ITEM(__pyx_t_1, 1, __pyx_n_s_points_avg);
  __Pyx_INCREF(__pyx_n_s_points_ceil);
  __Pyx_GIVEREF(__pyx_n_s_points_ceil);
  PyList_SET_ITEM(__pyx_t_1, 2, __pyx_n_s_points_ceil);
  __Pyx_INCREF(__pyx_n_s_points_floor);
  __Pyx_GIVEREF(__pyx_n_s_points_floor);
  PyList_SET_ITEM(__pyx_t_1, 3, __pyx_n_s_points_floor);
  __Pyx_INCREF(__pyx_n_s_name);
  __Pyx_GIVEREF(__pyx_n_s_name);
  PyList_SET_ITEM(__pyx_t_1, 4, __pyx_n_s_name);
  __Pyx_INCREF(__pyx_n_s_salary);
  __Pyx_GIVEREF(__pyx_n_s_salary);
  PyList_SET_ITEM(__pyx_t_1, 5, __pyx_n_s_salary);
  __Pyx_INCREF(__pyx_n_s_position);
  __Pyx_GIVEREF(__pyx_n_s_position);
  PyList_SET_ITEM(__pyx_t_1, 6, __pyx_n_s_position);
  __Pyx_INCREF(__pyx_n_s_team);
  __Pyx_GIVEREF(__pyx_n_s_team);
  PyList_SET_ITEM(__pyx_t_1, 7, __pyx_n_s_team);
  __Pyx_INCREF(__pyx_n_s_opposing_team);
  __Pyx_GIVEREF(__pyx_n_s_opposing_team);
  PyList_SET_ITEM(__pyx_t_1, 8, __pyx_n_s_opposing_team);
  __Pyx_INCREF(__pyx_n_s_median_value);
  __Pyx_GIVEREF(__pyx_n_s_median_value);
  PyList_SET_ITEM(__pyx_t_1, 9, __pyx_n_s_median_value);
  __Pyx_INCREF(__pyx_n_s_upper_value);
  __Pyx_GIVEREF(__pyx_n_s_upper_value);
  PyList_SET_ITEM(__pyx_t_1, 10, __pyx_n_s_upper_value);
  __Pyx_INCREF(__pyx_n_s_lower_value);
  __Pyx_GIVEREF(__pyx_n_s_lower_value);
  PyList_SET_ITEM(__pyx_t_1, 11, __pyx_n_s_lower_value);
  __Pyx_INCREF(__pyx_n_s_median);
  __Pyx_GIVEREF(__pyx_n_s_median);
  PyList_SET_ITEM(__pyx_t_1, 12, __pyx_n_s_median);
  __Pyx_INCREF(__pyx_n_s_upper);
  __Pyx_GIVEREF(__pyx_n_s_upper);
  PyList_SET_ITEM(__pyx_t_1, 13, __pyx_n_s_upper);
  __Pyx_INCREF(__pyx_n_s_lower);
  __Pyx_GIVEREF(__pyx_n_s_lower);
  PyList_SET_ITEM(__pyx_t_1, 14, __pyx_n_s_lower);
  __Pyx_INCREF(__pyx_n_s_salary_remaining);
  __Pyx_GIVEREF(__pyx_n_s_salary_remaining);
  PyList_SET_ITEM(__pyx_t_1, 15, __pyx_n_s_salary_remaining);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_LINEUP_COLUMNS, __pyx_t_1) < 0) __PYX_ERR(0, 4, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init dfs.constants", 0, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init dfs.constants");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
